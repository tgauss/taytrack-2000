...
export const cityPOIs: Record<string, POI[]> = {
  tulsa: [
    ...
    },
    {
      ...
      emoji: '🐧',
      lngLat: [-95.9259, 36.1500],
      funFact: 'Big, colorful 6-foot-tall penguin statues hiding all over the city!',
      color: '#60a5fa',
      imageUrl: getPoiImage('tulsa-penguins', -95.9259, 36.1500),
    ...
    },
    {
      ...
      emoji: '🕳️',
      lngLat: [-95.9930, 36.1540],
      funFact: 'A hidden maze of hallways right underneath the city streets!',
      color: '#6b7280',
      imageUrl: getPoiImage('tulsa-tunnels', -95.993, 36.154),
  ...
  lincoln: [
    ...
    },
    {
      ...
      color: '#dc2626',
      imageUrl: getPoiImage('lincoln-stadium', -96.7032, 40.8206),
    ...
    },
    {
      ...
      color: '#92400e',
      imageUrl: getPoiImage('lincoln-morrill', -96.7004, 40.8141),
    ...
    },
    {
      ...
      color: '#f97316',
      imageUrl: getPoiImage('lincoln-haymarket', -96.7143, 40.8169),
    ...
    },
    {
      ...
      color: '#ec4899',
      imageUrl: getPoiImage('lincoln-sunken-gardens', -96.6701, 40.8247),
  ...
  roca: [
    {
      ...
      color: '#f97316',
      imageUrl: getPoiImage('roca-berry-farm', -96.6570, 40.6380),
  ...
  omaha: [
    {
      ...
      color: '#4ade80',
      imageUrl: getPoiImage('omaha-zoo', -95.9285, 41.2260),
    ...
    },
    {
      ...
      color: '#60a5fa',
      imageUrl: getPoiImage('omaha-bridge', -95.9225, 41.2586),
    ...
    },
    {
      ...
      color: '#eab308',
      imageUrl: getPoiImage('omaha-durham', -95.9370, 41.2522),
    ...
    },
    {
      ...
      color: '#f97316',
      imageUrl: getPoiImage('omaha-old-market', -95.9312, 41.2558),
    ...
    },
    {
      ...
      color: '#6b7280',
      imageUrl: getPoiImage('omaha-bigboy', -95.9214, 41.2410),
