...
// Generate a Mapbox Static Image URL for any location (aerial satellite view)
function poiImage(lng: number, lat: number, zoom = 17): string {
...
const LOCAL_PHOTOS: Record<string, string> = {
  // Tulsa
  'tulsa-golden-driller': '/landmarks/golden-driller.webp',
  'tulsa-center-universe': '/landmarks/center-universe.webp',
  'tulsa-penguins': '/landmarks/penguins.webp',
  'tulsa-cave-house': '/landmarks/cave-house.webp',
  'tulsa-tunnels': '/landmarks/tunnels.webp',
  'tulsa-elephant-law': '/landmarks/elephant-law.webp',
  'tulsa-time-capsule': '/landmarks/time-capsule.webp',
  'tulsa-yield-sign': '/landmarks/yield-sign.webp',
  'tulsa-route66': '/landmarks/route66.webp',
  'tulsa-blue-whale': '/landmarks/blue-whale.webp',
  'tulsa-gathering-place': '/landmarks/gathering-place.webp',
  // Lincoln
  'lincoln-capitol': '/landmarks/capitol.webp',
  'lincoln-stadium': '/landmarks/memorial-stadium.webp',
  'lincoln-morrill': '/landmarks/morrill-hall.webp',
  'lincoln-haymarket': '/landmarks/haymarket.webp',
  'lincoln-sunken-gardens': '/landmarks/sunken-gardens.webp',
  // Roca
  'roca-berry-farm': '/landmarks/roca-berry-farm.webp',
  'roca-warehouse': '/landmarks/roca-warehouse.webp',
  // Omaha
  'omaha-zoo': '/landmarks/desert-dome.webp',
  'omaha-bridge': '/landmarks/bob-kerrey-bridge.webp',
  'omaha-durham': '/landmarks/durham-museum.webp',
  'omaha-old-market': '/landmarks/old-market.webp',
  'omaha-bigboy': '/landmarks/big-boy-train.webp',
};
...
export interface POI {
  ...
  imageUrl?: string; // Auto-generated satellite image or custom URL
...
export const cityPOIs: Record<string, POI[]> = {
  tulsa: [
    ...
    },
    {
      ...
      cityId: 'tulsa',
      name: 'The Secret "Center of the Universe"',
      emoji: '🔮',
      lngLat: [-95.9851, 36.1561],
      funFact: 'A magical circle of bricks downtown where your voice does a super silly trick!',
      color: '#a855f7',
      imageUrl: getPoiImage('tulsa-center-universe', -95.9927, 36.1565),
      historyLesson: 'If you stand exactly in the middle of this brick circle and clap or shout, your voice echoes back to you super loud! But the funny science fact is that anyone standing right outside the circle can\'t hear the echo at all. It\'s a real-life acoustic mystery! Scientists think the surrounding walls bounce the sound waves back to the center like a mirror bounces light. But nobody is 100% sure why it works!',
      didYouKnow: 'The circle is only about 8 feet wide — the size of a small trampoline! Step one foot outside and the magic completely stops.',
    },
    {
      id: 'tulsa-penguins',
      cityId: 'tulsa',
      name: 'The Giant Hiding Penguins',
      emoji: '🐧',
      lngLat: [-95.9285, 36.1502],
      funFact: 'Big, colorful 6-foot-tall penguin statues hiding all over the city!',
      color: '#60a5fa',
      imageUrl: getPoiImage('tulsa-penguins', -95.9285, 36.1502),
      historyLesson: 'Real penguins like cold water, but Tulsa has special painted penguin statues that love the warm sunshine! Originally, 29 giant penguins were made to help raise money for the Tulsa Zoo, and now they are scattered around town like a giant scavenger hunt. Each one is painted differently — some have flowers, some have cityscapes, and some look like superheroes!',
      didYouKnow: 'The penguins are 6 feet tall — taller than most grown-ups! Can you imagine a penguin looking you right in the eye?',
    },
    {
      id: 'tulsa-cave-house',
      cityId: 'tulsa',
      name: 'The Real-Life Cave House',
      emoji: '🏚️',
      lngLat: [-96.0111, 36.1518],
      funFact: 'A bumpy, lumpy house that looks exactly like it was built out of giant cartoon rocks!',
      color: '#92400e',
      imageUrl: getPoiImage('tulsa-cave-house', -96.0111, 36.1518),
      historyLesson: 'Built over 100 years ago, this house looks exactly like it belongs to the Flintstones! It was made with steep, bumpy walls and tiny windows, and it even has secret passageways hidden inside. The outside is covered in rough, rocky-looking material that makes it look like a real cave from the Stone Age!',
      didYouKnow: 'The house has been there for over 100 years and people still drive from far away just to see it because it looks so crazy!',
    },
    {
      id: 'tulsa-tunnels',
      cityId: 'tulsa',
      ...
      emoji: '🕳️',
      lngLat: [-95.9928, 36.154],
      funFact: 'A hidden maze of hallways right underneath the city streets!',
      color: '#6b7280',
      imageUrl: getPoiImage('tulsa-tunnels', -95.9928, 36.154),
      historyLesson: 'Long ago, workers built tunnels under downtown Tulsa so people could walk between big office buildings without ever going outside. It was the perfect way to stay warm during freezing winter snowstorms and dry during rainy days! The tunnels connect several buildings downtown and most people walking above don\'t even know they\'re there!',
      didYouKnow: 'The tunnels are like a secret underground city! You could walk from building to building without ever seeing the sky!',
    },
    {
      id: 'tulsa-elephant-law',
      cityId: 'tulsa',
      name: 'No Pet Elephants Allowed!',
      emoji: '🐘',
      lngLat: [-95.9895, 36.1498],
      funFact: 'A very silly, but very real, law about walking an elephant in the city!',
      color: '#ec4899',
      imageUrl: getPoiImage('tulsa-elephant-law', -95.9895, 36.1498),
      historyLesson: 'Every city has rules, but Tulsa has a super funny old law still on the books: it is completely illegal to walk an elephant down the streets of downtown! So if you ever get a pet elephant, she definitely has to stay home! Nobody knows exactly why this law was made, but it\'s still officially a rule!',
      didYouKnow: 'This law is still real and has never been removed! Even though nobody has tried to walk an elephant downtown in a very long time.',
    },
    {
      id: 'tulsa-time-capsule',
      cityId: 'tulsa',
      name: 'A Time Capsule... Made of a Car!',
      emoji: '🚗',
      lngLat: [-95.9922, 36.156],
      funFact: 'A real sports car was buried underground like pirate treasure — it won\'t come out until 2048!',
      color: '#eab308',
      imageUrl: getPoiImage('tulsa-time-capsule', -95.9922, 36.156),
      historyLesson: 'In 1998, the city of Tulsa buried a shiny Plymouth Prowler sports car in a concrete vault underground to save it for the future. They won\'t dig it back up until the year 2048! By the time it comes out of the ground, both of you will be all grown up! They also put in other things from 1998 so people in the future can see what life was like.',
      didYouKnow: 'The car has been underground for almost 30 years already! It still has 22 more years to go before anyone gets to see it again!',
    },
    {
      id: 'tulsa-yield-sign',
      cityId: 'tulsa',
      name: 'The Very First YIELD Sign',
      emoji: '⚠️',
      lngLat: [-95.9845, 36.1494],
      funFact: 'The famous triangle yield sign that\'s everywhere was invented right here in Tulsa!',
      color: '#eab308',
      imageUrl: getPoiImage('tulsa-yield-sign', -95.9845, 36.1494),
      historyLesson: 'Do you know the triangle sign that tells cars to slow down and "yield"? A Tulsa police officer named Clinton Riggs invented it in 1950! Tulsa was the very first city in the whole wide world to use one to keep drivers safe. Now yield signs are used in every city and every country around the world — and it all started right here!',
      didYouKnow: 'Before the yield sign was invented, there was no way to tell drivers to slow down without making them stop completely!',
    },
    {
      id: 'tulsa-route66',
      cityId: 'tulsa',
      name: 'The Mother Road (Route 66)',
      emoji: '🛣️',
    ...
    },
    {
      ...
      cityId: 'tulsa',
      name: 'The Ultimate Giant Playground',
      emoji: '🎢',
  ...
  lincoln: [
    ...
    },
    {
      ...
      emoji: '🏈',
      lngLat: [-96.707, 40.8194],
      funFact: 'Every game sold out since 1962 — over 400 in a row! World record!',
      color: '#dc2626',
      imageUrl: getPoiImage('lincoln-stadium', -96.707, 40.8194),
    ...
    },
    {
      ...
      emoji: '🦣',
      lngLat: [-96.7012, 40.8092],
      funFact: 'Archie the mammoth is 14 feet tall — discovered by CHICKENS!',
      color: '#92400e',
      imageUrl: getPoiImage('lincoln-morrill', -96.7012, 40.8092),
    ...
    },
    {
      ...
      name: 'Sunken Gardens',
      emoji: '🌸',
      lngLat: [-96.6858, 40.7863],
      funFact: 'This used to be a garbage dump! Now it has 30,000 flowers!',
      color: '#ec4899',
      imageUrl: getPoiImage('lincoln-sunken-gardens', -96.6858, 40.7863),
  ...
  roca: [
    {
      ...
      emoji: '🎃',
      lngLat: [-96.647, 40.638],
      funFact: 'Goats, bunnies, zip lines, and a giant pillow you can JUMP on!',
      color: '#f97316',
      imageUrl: getPoiImage('roca-berry-farm', -96.647, 40.638),
    ...
    },
    {
      ...
      color: '#a855f7',
      imageUrl: getPoiImage('roca-warehouse', -96.6653, 40.6481),
...
// Home to PDX airport drive route (13418 SE Silver Cir → PDX)
const HOME_TO_PDX: [number, number][] = [
  [-122.553936,45.604761],[-122.554095,45.605474],[-122.55278,45.605827],[-122.552081,45.604844],[-122.551184,45.600498],[-122.549817,45.59563],[-122.546593,45.589624],[-122.54507,45.587072],[-122.544218,45.584985],[-122.543832,45.583086],[-122.543798,45.580892],[-122.544199,45.578733],[-122.546336,45.574529],[-122.549045,45.572938],[-122.55381,45.573355],[-122.55754,45.575352],[-122.569494,45.579986],[-122.580533,45.584277],[-122.586095,45.587328],[-122.591537,45.58962],[-122.593353,45.588213],
];

export function getHomeToPDXRoute(): [number, number][] {
  return HOME_TO_PDX;
}
