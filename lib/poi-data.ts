...
export const cityPOIs: Record<string, POI[]> = {
  tulsa: [
    ...
    },
    {
      ...
      color: '#60a5fa',
      imageUrl: getPoiImage('tulsa-blue-whale', -95.7634, 36.2398),
    ...
    },
    {
      ...
      color: '#4ade80',
      imageUrl: getPoiImage('tulsa-gathering-place', -95.9767, 36.1348),
    ...
    },
    {
      ...
      color: '#eab308',
      imageUrl: getPoiImage('tulsa-route66', -95.9846, 36.1493),
