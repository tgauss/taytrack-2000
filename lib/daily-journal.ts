...
export const journalEntries: JournalEntry[] = [
  ...
  },
  {
    ...
    emoji: '🏠',
    voScript: "Day eight! THE BEST DAY EVER! Dad got on a plane in Omaha, flew to Seattle, and then flew home! Eight whole days of adventures! He went to a conference in Tulsa where there's a giant golden statue and a magic echo circle. He drove through Kansas where it's flatter than a pancake. He packed three hundred and seventy nine orders in tiny Roca Nebraska where only two hundred people live. He visited cities named after a president, after a rock, and after brave people who walk against the wind! He traveled over three thousand miles! But the very best part of the whole entire trip? Coming home to YOU! Time for the biggest hugs EVER!",
    funDetail: "Dad traveled 3,000+ miles — that's like driving to the Statue of Liberty and back!",
    sleepsLeft: 0,
