...
// Lazy-load all modal/game/panel components — only the map loads eagerly
const CityModal = dynamic(() => import('@/components/game/CityModal').then(m => m.CityModal), { ssr: false });
const AchievementPopup = dynamic(() => import('@/components/game/AchievementPopup').then(m => m.AchievementPopup), { ssr: false });
const BadgeCollection = dynamic(() => import('@/components/game/BadgeCollection').then(m => m.BadgeCollection), { ssr: false });
const DailyJournal = dynamic(() => import('@/components/game/DailyJournal').then(m => m.DailyJournal), { ssr: false });
const LandmarkExplorer = dynamic(() => import('@/components/game/LandmarkExplorer').then(m => m.LandmarkExplorer), { ssr: false });
const CityExplorer = dynamic(() => import('@/components/game/CityExplorer').then(m => m.CityExplorer), { ssr: false });
const ArrivalCelebration = dynamic(() => import('@/components/game/ArrivalCelebration').then(m => m.ArrivalCelebration), { ssr: false });
const SendHug = dynamic(() => import('@/components/game/SendHug').then(m => m.SendHug), { ssr: false });
const GoodNight = dynamic(() => import('@/components/game/GoodNight').then(m => m.GoodNight), { ssr: false });
const PackingGame = dynamic(() => import('@/components/games/PackingGame').then(m => m.PackingGame), { ssr: false });
const MemoryGame = dynamic(() => import('@/components/games/MemoryGame').then(m => m.MemoryGame), { ssr: false });
import { useNewMessages } from '@/components/game/KiddoConnect';
const KiddoConnect = dynamic(() => import('@/components/game/KiddoConnect').then(m => m.KiddoConnect), { ssr: false });
